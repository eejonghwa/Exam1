package day_7.accessModifier;

// 접근제어자
public class AccessModifier {
    public static void main(String[] args) {

        // public -> 어디서든 누구나 접근 가능 (필수)
        // protected -> 같은 패키지(폴더) + 상속관계에서만 가능
        // default -> 같은 패키지에서만 가능
        // private -> 자기 자신만 가능 (필수)
...
//        c1.num2 = 0;
        ...
        // Calculator는 다른 폴더에 존재하고 Calculator2의 plus() 메서드는 접근제어자가 default이기 때문에 여기서 사용 불가능
