package day_8.arraylistEx_1;

import java.util.ArrayList;

// {5,4,3,2,1,0}을 ArrayList에 추가 해주세요.
// ArrayList의 사이즈를 출력해주세요.
// ArrayList의 3,4번째 값을 읽어서 출력해주세요. (인덱스 기준X)
...
public class exam1 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> 정수저장소 = new ArrayList<>();
